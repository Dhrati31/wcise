  ...
  return (
    <div className='mt-10 ml-4 mr-4 mb-4'>
        ...
        <div className='flex flex-col items-center justify-center gap-8'>
            ...
            <div>
              <div className='text-4xl font-bold text-center my-8 text-[#1d3b58] lg:text-6xl'>VENUE</div>
              <h2 className='text-3xl  text-center inter'>Citrus Grand Pattaya, Pattaya,<div>Thailand.</div></h2>
            </div>
        </div>
    </div>
  )
