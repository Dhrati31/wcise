        ...
        <div className="max-w-7xl mx-auto space-y-2 text-lg sm:text-xl leading-relaxed">
          <div>
            ...
            <p className='text-justify'>
              Registration fee is non-refundable. At least one author must register to ensure publication. All attending authors must register separately.
            </p>
          </div>
          <div>
            <p className="font-bold text-3xl mt-12 sm:text-4xl mb-6 text-justify">Important :</p>
